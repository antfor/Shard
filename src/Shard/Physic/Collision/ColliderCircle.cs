...
namespace Shard
{
    class ColliderCircle : Collider
    {
        ...
        public ColliderCircle(CollisionHandler gob, Transform2D t) : base(gob)
        {
        ...
        public ColliderCircle(CollisionHandler gob, Transform2D t, float x, float y, float rad) : base(gob)
        {
        ...
        public override Vector checkCollision(ColliderRect other)
        {
            ...
            if (dist < Rad)
            {
                ...
                else
                {
                    ...
                    dir = new Vector((float)dx, (float)dy);

                    dir.normalize();
                    dir.multiply((float)depth);
                }
        ...
        public override Vector checkCollision(Vector c)
        {
